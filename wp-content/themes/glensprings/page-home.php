                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="overflow-hidden">
                                        <div class="wow custom-anim-left">
                                            <h1 class="h1_big mb-5 fadeScroll relative" data-scroll-speed="-2"><?=get_field('banner_heading'); ?></h1>
                                            <a class="btn-main fadeScroll relative" href="<?=get_field('banner_button_link'); ?>" data-scroll-speed="-6"><?=get_field('banner_button_text'); ?></a>
                                        </div>
                                    </div>                      
                                </div>
...
<div class="box pb-5">
                                    ...
                                    <span><a class="btn-main" href="<?php echo $field['section_2_loop_button_link']; ?>"><?php echo $field['section_2_loop_button_text']; ?></a></span>
                                </div>
<?php
}
 ?>
                    ...
                    <div class="container">
                        <div class="methe-inner">
                            <div class="row pb-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="left">
                                        <h2 class="big"><span style="color: var(--primary-color2);"><?=CFS()->get( 'section_3_heading' ); ?></h2>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="right text-end">
                                        <a class="btn-main relative" href="<?=CFS()->get( 'section_3_button_link' ); ?>"><?=CFS()->get( 'section_3_button_text' ); ?></a>
                                    </div>
                                </div>
                            </div>
 ...
 ?>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-11 col-md-8">
                            <div class="bug-inner text-center">
                                ...
                                <span><a class="btn-main" href="<?=get_field('section_4_button_link'); ?>"><?=get_field('section_4_button_text'); ?></a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="section-resume" class="p-0">
                <div class="container">
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="" data-bottom-top="transform: translateX(-150px);" data-top-bottom="transform: translateX(150px);">                              
                                <div class="de_count">
                ...
                <section class="whiteBlug">
                    <div class="container">
                        <div class="single-inner text-dark">
                            <h2 class="text-dark ultra-big s2"><span style="color: var(--primary-color2);"><?=get_field('section_5_heading_1'); ?></h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" style="padding-left: 50px;">
                                    <div class="single-rht">
                                        ...
                                        <span><a class="btn-main" href="<?=get_field('section_5_button_link'); ?>"><?=get_field('section_5_button_text'); ?></a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
