                            ...
                            <div class="col-md-9">
                                ...
                                <div class="overflow-hidden">
                                    <div class="wow custom-anim-left">
                                        <h1 class="h1_big mb-5 fadeScroll relative" data-scroll-speed="-2"><?=CFS()->get( 'about_banner' ); ?></h1>
                                    </div>
                                </div>                      
                            </div>
                ...
                <div class="container">
                    <div class="row justify-content-between">
                        <div class="col-md-4 relative" id="">
                            <div  class="sidebar">
                                <div class="headings">
                                    <h2 class="big"><?=CFS()->get( 'section_2_heading' ); ?></span>
</h2>
...
?>
            ...
            <section id="section-services" aria-label="section" style="background: var(--primary-color2);">
                <div class="container">
                    <div class="row gx-5 align-items-center">
                        <div class="col-lg-6">
                            <div class="row g-5" data-bottom-top="transform: translateY(-50px);" data-top-bottom="transform: translateY(50px);">
...
<div class="col-lg-6 col-6 wow fadeIn" data-wow-delay="0">
                                    <div class="de_count text-center">
                                        <h3 class="timer" data-to="20000" data-speed="2500"><?php  echo $field2['section_3_loop_1_text_1']; ?></h3>
...
<?php
                        ...
                        ?>
                                ...
                                <!-- <blockquote class="q-big wow fadeIn" data-wow-duration="3s">
                                    <i class="d-big icon_quotations"></i>
                                    Glenspring really helped us speed up the development of our new code projects without taking on expensive new in-house developers. The Glenspring team has also given us greater flexibility as we develop new modules and features.
                                    <span class="d-quote-by">Will Atkinson, President of CAP Software</span>
                                </blockquote>

                                <blockquote class="q-big wow fadeIn" data-wow-duration="3s">
                                    <i class="d-big icon_quotations"></i>
                                    Glenspring seemed too good to be true, but it really was true. I was impressed by the efficiency of the on-shore/off-shore model, and by the overall methodology and project management discipline. We will be using Glenspring again.
                        ...
                        <div class="item overflow-hidden">
                            <div class="wow custom-anim-right">
                                <div class="card-image-1 mod-c">
                                    <a href="project-single-1.html">
                                        <div class="d-text">
                                            <h3>THE Glenspring FOUNDATION</h3>
...
<div class="col-lg-4 col-6">
                            <div class="de-skill-item bg-white p-2" data-bottom-top="transform: translateX(<?php echo ($it===1 || $it===2 || $it===3) ? '-150' : '150'; ?>px);" data-top-bottom="transform: translateX(<?php echo ($it===1 || $it===2 || $it===3) ? '150' : '-150'; ?>px);">
...
<li class="mt-3 col-6 col-sm-4 col-md-3"><img src="<?php echo $field6['partnership_loop_image']; ?>" alt="" class="img-fluid"></li>
