                            ...
                            <div class="col-md-9">
                                ...
                                <div class="overflow-hidden">
                                    <div class="wow custom-anim-left">
                                        <h1 class="h1_big mb-2 fadeScroll relative text-uppercase" data-scroll-speed="-2"></span><?=CFS()->get( 'banner_heading_1' ); ?></h1>
                                        <h4><?=CFS()->get( 'banner_heading_2' ); ?></h1></h4>
                                    </div>
                                </div>                      
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 wow fadeInUp">
                            <h2 class="wow custom-scale-in-mask"><?=CFS()->get( 'section_1_heading' ); ?></h1></h2>
                            <p><?=CFS()->get( 'section_1_content' ); ?></h1></p>
                        </div>
                    </div>
                    <div class="spacer-single"></div>
                    <div class="row align-items-center">
                        <div class="col-lg-6 mb-sm-30">
                            <figure class="cap-front overflow-hidden" data-bottom-top="transform: translateY(50px);" data-top-bottom="transform: translateY(-50px);">
                                <img src="<?=CFS()->get( 'section_1_image' ); ?>" class="img-fluid wow custom-anim-right" alt="">
                            </figure>
                        </div>
...
$fields = CFS()->get( 'section_1_loop' );
foreach ( $fields as $field ) {
  
?>

<div class="box">
                                <!-- <span><img src="<?php //echo get_template_directory_uri(); ?>/images/001-app-development.png" alt=""></span> -->
                                <h3 style="color:var(--primary-color2)"><?php   echo $field['section_1_loop_heading']; ?></h3>
                                <p><?php  echo $field['section_1_loop_content']; ?></p>
                            </div>
...
?>
                            ...
                            <!-- <div class="box">
                                ...
                                <h3 style="color:var(--primary-color2)">White-Label Glenspring’s Developers</h3>
                                <p>Use Glenspring’s trained and certified development team to offer expert-level product support and services to your customers. Your business will benefit from the extra bandwidth from “your” developers.</p>
                            </div>
                            <div class="box">
                               
                                <h3 style="color:var(--primary-color2)">Direct Affiliate</h3>
                                <p>Make Glenspring your go-to implementation and customization partner. Glenspring will directly service your client’s software needs, and you’ll profit throughout the duration of each project.</p>
                            </div>
                            <div class="box">
                               
                                <h3 style="color:var(--primary-color2)">Business Referrals</h3>
                                <p>Prefer a more hands-off approach? No problem! Refer your business users to Glenspring and receive a flat rate for each referral. We will handle everything from there.
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-11 wow fadeInUp mb-4">
                            <h5 class="wow fadeInUp"><?=CFS()->get( 'section_2_heading_1' ); ?></h1></h5>
                            <h2 class="wow custom-scale-in-mask"> <?=CFS()->get( 'section_2_heading_2' ); ?></h1></h2>
                            <p><?=CFS()->get( 'section_2_content' ); ?></h1></p>
                            <div class="spacer-half"></div>
                        </div>
                    </div>
                    <div class="row gh-5">
                        <div class="col-lg-6 wow fadeInUp">
                            <div class="p-0" data-bottom-top="transform: translateY(50px);" data-top-bottom="transform: translateY(-50px);">
                                <ul class="d_timeline">
...
<li class="d_timeline-item wow fadeInUp">
                                        ...
                                        <div class="mb-4 d_timeline-text">
                                                <span><img src="<?php echo get_template_directory_uri(); ?>/images/icons/fedex.png" alt="" class="logos"></span>
                                                <span><img src="<?php echo get_template_directory_uri(); ?>/images/icons/ups.png" alt="" class="logos"></span>
                                                <span><img src="<?php echo get_template_directory_uri(); ?>/images/icons/usps.png" alt="" class="logos"></span>
                                            </div>
                                    </li>
 ...
 ?>
                                    <!-- <li class="d_timeline-item wow fadeInUp">
                                        ...
                                        <p class="d_timeline-text">
                                            Have your clients been asking you for software customization? Are you too busy to help? Ease your burden by letting the developers at Glenspring make the requested changes to your software.</p>
                                    </li>
                                    <li class="d_timeline-item wow fadeInUp">
...
<?php
 ...
 ?>
                                    ...
                                    <li class="d_timeline-item wow fadeInUp">
                                        ...
                                        <p class="d_timeline-text">                                          
                                            Have your clients encountered issues? Do they want short-term help at a flat rate? Glenspring offers technical and non-technical support through our block-of-hours program.</p>
                                    </li> -->
                                </ul>
                            </div>
                        </div>
            ...
            <section id="section-about2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 wow fadeInUp">
                            <h2 class="wow custom-scale-in-mask"><?=CFS()->get( 'section_3_heading' ); ?></h1></h2>
                            <p><?=CFS()->get( 'section_3_content' ); ?></h1></p>
                        </div>
                    </div>
                    <div class="spacer-single"></div>
                    <div class="row align-items-center flex-row-reverse">
                        <div class="col-lg-6 mb-sm-30">
                            <figure class="cap-front overflow-hidden" data-bottom-top="transform: translateY(50px);" data-top-bottom="transform: translateY(-50px);">
                                <img src="<?=CFS()->get( 'section_3_image' ); ?>" class="img-fluid wow custom-anim-right" alt="">
                            </figure>
                        </div>
                        <div class="col-lg-6 wow fadeInUp">
...
$fields4 = CFS()->get( 'section_3_loop' );
...
<div class="box">
                                <!-- <span><img src="<?php //echo get_template_directory_uri(); ?>/images/001-app-development.png" alt=""></span> -->
                                <h3 style="color:var(--primary-color2)"><?php   echo $field4['section_3_loop_heading']; ?></h3>
                                <p><?php  echo $field4['section_3_loop_content']; ?></p>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6" style="padding-left: 50px;">
                                    <div class="single-rht text-white">
                                        <h2 class="ultra-big s2 mb-3">Join Our <span style="color:var(--primary-color2)">Partner Program</span></h2>
                                        <h4>Don’t miss out on new business opportunities. Become a Glenspring Channel Partner today. To get started, fill out the form below to learn more about the Channel Partner benefits.
...
<div class="accordion-item">
                                        <h2 class="accordion-header" id="heading-<?=$ac; ?>">
                                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-<?=$ac; ?>"><?php echo $field5['faq_loop_heading']; ?></button>									
                                        </h2>
                                        <div id="collapse-<?=$ac; ?>" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                                            <div class="card-body">
...
<div class="accordion-item">
                                        <h2 class="accordion-header" id="heading-t-<?=$dc; ?>">
                                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-t-<?=$dc; ?>"><?php echo $field6['faq_loop_heading2']; ?></button>									
                                        </h2>
                                        <div id="collapse-t-<?=$dc; ?>" class="accordion-collapse collapse" data-bs-parent="#myAccordion">
                                            <div class="card-body">
